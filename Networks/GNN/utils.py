...
def print_info(
    id, obs, node_obs, adj, action=None, reward=None, next_obs=None, next_node_obs=None, next_adj=None, done=None
) -> None:
    print("-" * 40)
    if done is not None:
...
def unbind(
    agent_id, obs, node_obs, adj, action=None, reward=None, next_obs=None, next_node_obs=None, next_adj=None, dones=None
) -> tuple:
